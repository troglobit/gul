# gul.spec
#
# Copyright (c) 2004 Joachim Nilsson crash@vmlinux.org
#
%define name gul
...
#Icon:
#URL:
#Packager: Joachim Nilsson crash@vmlinux.org
...
Summary: The one true GUL editor!

%description
The one true GUL editor!
gul.spec.  Generated from gul.spec.in by configure.
Please edit gul.spec.in to add several more lines of description
